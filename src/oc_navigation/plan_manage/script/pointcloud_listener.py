...
class PointCloudListener:
    def __init__(self):
        self.input_folder = '/root/Aerial-Walker/src/oc_navigation/plan_manage/raw_data/velodyne'
        self.output_folder = '/root/Aerial-Walker/src/oc_navigation/plan_manage/raw_data/voxels'
